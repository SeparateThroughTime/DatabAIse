...
def get_test_page(request):
    ...
    table_labels.append(justpy.Label(a=form, text="Tabelle 1:", classes=CssStyles.label_classes))
    table_inputs.append(justpy.Input(a=form, type="text", name="table1", value="Bands", classes=CssStyles.input_classes))
    table_labels[0].for_component = table_inputs[0]

    table_labels.append(justpy.Label(a=form, text="Tabelle 2:", classes=CssStyles.label_classes))
    table_inputs.append(justpy.Input(a=form, type="text", name="table2", value="Alben", classes=CssStyles.input_classes))
    table_labels[1].for_component = table_inputs[1]

    table_labels.append(justpy.Label(a=form, text="Tabelle 3:", classes=CssStyles.label_classes))
    table_inputs.append(justpy.Input(a=form, type="text", name="table3", value="Titel", classes=CssStyles.input_classes))
    table_labels[2].for_component = table_inputs[2]

    table_labels.append(justpy.Label(a=form, text="Tabelle 4:", classes=CssStyles.label_classes))
    table_inputs.append(justpy.Input(a=form, type="text", name="table4", value="Konzerte", classes=CssStyles.input_classes))
...
def get_page(request):
    ...
    i = 1
    for key in tables:
        table_labels.append(justpy.Label(a=form, text="Tabelle " + str(i) + ":", classes=CssStyles.label_classes))
