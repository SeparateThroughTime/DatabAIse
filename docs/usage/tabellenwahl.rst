...
oder sogar ersetzt werden (**a**). Sobald alles wie gewünscht eingerichtet ist,
kann mit „Senden“ (**b**) mit der :doc:`/usage/attributswahl` fortgefahren
werden.

.. attention::

    Hier sollten keine Relationstabellen angegeben werden. Diese werden erst
    später automatisch erzeugt.
